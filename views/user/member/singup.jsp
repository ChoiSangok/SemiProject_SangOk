...
<body>
			...
			<section id="banner">			
				<div class="content">
					...
					<p>모 두 환 영 합 니 다</p>
					<ul class="actions">
						<li><a href="#one" class="button scrolly">회원가입</a></li>
					</ul>
				</div>
			</section>
...
<div class="container">
	...
	<h5 id="one"  style="text-align: center;"><i class="fas fa-paw" style="color :purple;"></i><span> 회원가입 </span><i class="fas fa-paw" style="color :purple;"></i></h5>
	<hr>
	<!-- 비밀번호 확인 해주기  -->
	<!-- 메인화면 으로 가야하지 않나..?-->
	<form action="/singup/singup" method="post" id="myForm">
   		...
   		<h5><label>아이디<span id="red">(필수)</span><br>
   		...
   		<h5><label>비밀번호<span id="red">(필수)</span>
		...
		<br><br><br>
   		<h5><label >이메일<span id="red">(필수)</span><br>
	...
	<hr><div style="margin:0 auto;text-align:center;">
		<input type="submit" value="가입하기" class="singup" style="font-size: 15px;"/><br>
		</div>
   </form>
</div>
