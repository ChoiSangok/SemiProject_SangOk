...
<br><br>
   ...
   <table>
      ...
      <tr>   
         <td>
            <h5><label>비밀번호<span id="red">(확인하기 위해 무조건 입력하셔야 합니다)</span>
            <input type="password" placeholder="비밀번호" name="userpw" id="userpwMod" required style=" width: 385px"/></label>
            <div id="pw_check"></div></h5>
         </td>
           <td>
            <h5><label>비밀번호확인<span id="red">(필수)</span>
            <input type="password" placeholder="비밀번호확인" name="userpw_ck" id="userpw_ck" required style="width: 385px"/></label>
            <div id="pw_check2"></div></h5>
            </td>
      </tr>

      <tr>
         <td>
              <h5><label>핸드폰<span id="red">( - 표시 없이 11자리로만 써주세요!)</span>
             <input type="tel" placeholder="- 없이 숫자만 써주세요(숫자11자리)" class="underline" name="usertel" maxlength="11" id="usertel" required style="height: 43px; width: 385px" value="${member.usertel }"/></label></h5>
         </td>
   
         <td>
               <h5><label>생년월일<span id="red">(필수)</span><br>
...
<!--      <input type="text" name="userbirth_dd" id="userbirth_dd" maxlength="2" placeholder="일" size="10" required style="height:30px"> -->
             <div id="year_check"></div></label></h5>
         </td>
